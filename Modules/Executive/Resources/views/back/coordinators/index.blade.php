...
@section('title','Regional Coordinators')
@section('content')
            ...
            <div class="page-title-box d-flex align-items-center justify-content-between">
              ...
              <div class="page-title-right">
                <ol class="breadcrumb m-0">
                  ...
                  <li class="breadcrumb-item active"> Regional Coordinators</li>
                </ol>
              </div>
          ...
          <div class="col-12">
            <div class="card">
              <div class="card-body">
                <div class="row">
                  <div class="col-6">
                    <h4 class="header-title pull-left">  Regional Coordinators</h4>
                  </div>
                  @can('add executive members')
                    <div class="col-6 d-flex justify-content-end">
                      <a href="{{ route('coordinators.create') }}" class="btn btn-success waves-effect waves-light float-right"><i class="mdi mdi-plus"></i>Add new</a>
                    </div>
                  @endcan
                </div>
