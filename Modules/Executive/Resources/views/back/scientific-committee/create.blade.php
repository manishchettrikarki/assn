...
@section('title','Add Scientific Committee')
@section('content')
                    ...
                    <div class="col-12">
                        <div class="card">
                            <div class="card-body">
                                ...
                                <div class="mb-5 mt-5">
                                    <form action="{{ route('scientific.committee.store') }}" method="post">
                                        @csrf
                                        <div class="row">
                                            ...
                                            <div class="col-md-6 col-lg-6 col-sm-12">
                                                <div class="form-group">
                                                    ...
                                                    <input type="text" value="{{ old('member_type') }}"
