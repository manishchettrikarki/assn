                    ...
                    <div class="col-12">
                        <div class="card">
                            <div class="card-body">
                                <div class="row">
                                    <div class="col-6">
                                        <h4 class="header-title pull-left"> Members</h4>
                                    </div>
                                    @can('add executive members')
                                        <div class="col-6 d-flex justify-content-end">
                                            <a href="{{ route('members.create') }}" class="btn btn-success waves-effect waves-light float-right"><i class="mdi mdi-plus"></i>Add new</a>
                                        </div>
                                    @endcan
                                </div>
