                    ...
                    <div class="col-12">
                        <div class="card">
                            <div class="card-body">
                                <div class="row">
                                    <div class="col-6">
                                        <h4 class="header-title pull-left">Update Members</h4>
                                    </div>
                                    @can('view members')
                                        <div class="col-6">
                                            <a href="{{ route('members.index') }}" class="btn btn-sm btn-success float-right">Back</a>
                                        </div>
                                    @endcan
                                </div>
                                        ...
                                        <div class="row">
                                            ...
                                            <div class="col-md-6 col-lg-6 col-sm-12">
                                                <div class="form-group">
                                                    ...
                                                    <input type="text"
                                                           value="{{ ((bool)old('hospital'))?old('hospital'):$member->hospital }}"
