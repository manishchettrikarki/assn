            ...
            <div class="container-fluid">
                        ...
                        <div class="page-title-box d-flex align-items-center justify-content-between">
                            ...
                            <div class="page-title-right">
                                <ol class="breadcrumb m-0">
                                    ...
                                    <li class="breadcrumb-item"><a href="javascript: void(0);">Update Template</a></li>
                ...
                <div class="row">
                    <div class="col-12">
                        <div class="card">
                            <div class="card-body">
                                <h4 class="header-title">Update Template</h4>

                                <form action="{{ route('newsletter.templates.update',$template->slug) }}" method="post" enctype="multipart/form-data">
                                    @csrf
                                    <div class="form-group">
                                        <label for="name">Name</label>
                                        <input type="text" value="{{ (is_null(old('name')))?$template->name:old('name') }}"
                                    ...
                                    <div class="form-group">
                                        ...
                                        <input type="text" class="form-control"
                                               value="{{ (is_null(old('subject')))?$template->subject:old('subject') }}"
                                    ...
                                    <div class="form-group">
                                        <textarea name="template" id="template"
                                                  cols="30" rows="10">{{ (is_null(old('template')))?$template->template:old('template') }}</textarea>
                                        @error('template')
                                        <code>{{ $message }}</code>
                                        @enderror
                                    </div>
