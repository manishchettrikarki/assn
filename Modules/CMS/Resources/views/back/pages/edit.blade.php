                ...
                <div class="row">
                    <div class="col-12">
                        <div class="page-title-box d-flex align-items-center justify-content-between">
                            <h4 class="mb-0 font-size-18">Update Page</h4>
                    ...
                    <div class="col-12">
                        <div class="card">
                            <div class="card-body">
                                ...
                                <form action="{{ route('cms.pages.update',$page->slug) }}" method="post" enctype="multipart/form-data">
                                    @csrf
                                    <div class="row">
                                        ...
                                        <div class="col-lg-6 col-md-6 col-sm-12">
                                            <div class="form-group">
                                                ...
                                                <input type="text" class="form-control"
                                                       value="{{ (old('metaTitle'))?old('metaTitle'):$page->meta_title }}"
                                    ...
                                    <div class="row">
                                        <div class="col-lg-6 col-md-6 col-sm-12">
                                            <div class="form-group">
                                                ...
                                                <input type="text" class="form-control"
                                                       value="{{ (old('metaDescription'))?old('metaDescription'):$page->meta_description }}"
                                        ...
                                        <div class="col-lg-6 col-md-6 col-sm-12">
                                            <div class="form-group">
                                                ...
                                                <input type="text" class="form-control"
                                                       value="{{ (old('tags'))?old('tags'):$page->tags }}"
                                                       id="tags" name="tags">
                                                @error('tags')
                                                <code>{{ $message }}</code>
                                                @enderror
                                    ...
                                    <div class="form-group">
                                        <textarea name="description" id="description" cols="30" rows="10">
                                                  {!! (old('description'))?old('description'):$page->content !!}
                                        </textarea>
                                    ...
                                    <div class="row">
                                        <div class="col-md-6 col-lg-6 col-sm-12">
                                            <div class="form-group">
                                                ...
                                                <input type="checkbox" {{ ($page->nav)?'checked':'' }}
                                                       id="menu" name="menu"
                                        ...
                                        <div class="col-md-6 col-lg-6 col-sm-12">
                                            <div class="form-group">
                                                ...
                                                <input type="checkbox" {{ ($page->publish)?'checked':'' }}
                                    ...
                                    <div class="col-lg-6 col-md-6 col-sm-12" id="menuForm" style="display: {{ ($page->nav)?'block':'none' }}">
                                        <div class="form-group">
